...
public class ScanActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    private void insertData()
    {
        try
        {
            ...
            switch(ID){
                ...
                case "4":
                    String bullID = myBundle.getString("val1");
                    String cdate = myBundle.getString("val2");
                    String htag = myBundle.getString("tagNo");
                    textView2.setText("Data received is \n"
                            + "Dose Name: = " + bullID + "\nDate: = " + cdate +  "\n Eartag =" + htag);


                    ContentValues initialValues3 = new ContentValues();
                    initialValues3.put("Eartag", htag);
                    initialValues3.put("Name", bullID);
                    initialValues3.put("Date", cdate);


                    db.insert("heat", "v1", initialValues3);
                   new Send_heat_Server().execute();
                    break;
    ...
    private class Send_dose_Server extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try {
                ...
                URL link = new URL("http://172.20.10.4:8080/web_war_exploded/"+"farm");
    ...
    private class Send_weight_Server extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try {
                ...
                URL link = new URL("http://172.20.10.4:8080/web_war_exploded/"+"weight");
    ...
    private class Send_feed_Server extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try {
                ...
                URL link = new URL("http://172.20.10.4:8080/web_war_exploded/"+"feed");
    ...
    /*******************************************************************************************/
    private class Send_heat_Server extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            try {
                URL link = new URL("http://172.20.10.4:8080/web_war_exploded/"+"heat");
                ...
                ContentValues initialValues3 = new ContentValues();
                initialValues3.put("Eartag", htag);
                initialValues3.put("Bull", bullID);
                initialValues3.put("Date", cdate);

                ArrayList<String> heatData = new ArrayList<>();
